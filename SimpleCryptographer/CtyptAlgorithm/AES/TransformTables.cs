...
namespace SimpleCryptographer.AES
{
    class TransformTables
    {
        ...
        public static readonly string[,] inverse_sbox = new string[,] { 
        ...
        public static readonly Matrix MixColumnFactor = new Matrix(BaseTransform.FromHexToBinary("02010103030201010103020101010302"));
        public static readonly Matrix Inverse_MixColumnFactor = new Matrix(BaseTransform.FromHexToBinary("0e090d0b0b0e090d0d0b0e09090d0b0e"));
        #endregion
